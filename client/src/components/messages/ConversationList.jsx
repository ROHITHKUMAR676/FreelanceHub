const ConversationList = ({
  ...
  return (
    <div className="h-full overflow-y-auto bg-white">
      <div className="sticky top-0 z-10 border-b border-gray-200 bg-brand-surface px-4 py-4 sm:px-6">
            ...
            <button
              ...
              className={`w-full rounded-xl border px-4 py-3 text-left transition ${
                isActive
                  ...
                  : 'border-gray-200 bg-brand-surface text-gray-700 hover:bg-gray-100'
              }`}
            >
